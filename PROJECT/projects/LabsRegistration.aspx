<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LabsRegistration.aspx.cs" Inherits="LabsRegistration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid FindNoPadding">
            <div class=" BackGroundClr FindNoMargin" style="background-image: url('../../images/pathalogy.jpg')">
                <p class="GetStartedText">Get Started With Online Best Medical Resolution System</p>
                <div class="row FindNoMargin">
                    <div class="col-sm-6 LeftDiv">
                        <center> <img src="images/hcue-partner-icon.png"/>
                        <p class="ImgHeading">Labs</p>
                        <p class="DescriptionHeading">
                            Be discovered and referred by doctors in your hyper locality.
                        </p>
                        <p>
                           Direct references from doctors in your neighbourhood. Patient can directly connect with you for prescription refills. Complete pharmacy management suit.
                        </p>
                        </center>
                    </div>
                    <div class="col-sm-6 FormDiv">
                        <asp:TextBox ID="LabRegNameTxt" CssClass="TextboxEditing" placeholder="Enter your full Name" runat="server"></asp:TextBox>
                        <asp:TextBox ID="LabRegEmailTxt" CssClass="TextboxEditing" placeholder="Enter your Email" runat="server" TextMode="Email"></asp:TextBox>
                        <asp:TextBox ID="LabRegPhoneTxt" CssClass="TextboxEditing" placeholder="Enter your Phone No" runat="server" TextMode="Phone"></asp:TextBox>
                        <asp:TextBox ID="LabRegPathologyNameTxt" CssClass="TextboxEditing" placeholder="Enter your Pathology Name" runat="server" TextMode="Phone"></asp:TextBox>
                        <asp:TextBox ID="LabRegCityTxt" CssClass="TextboxEditing" placeholder="Enter your City" runat="server" TextMode="Phone"></asp:TextBox>
                        <asp:TextBox ID="LabRegPwdTxt" CssClass="TextboxEditing" placeholder="Enter your Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:TextBox ID="LabRegCnfPwdTxt" CssClass="TextboxEditing" placeholder="Confirm Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:Label ID="LabRegMsgLbl" CssClass="LableBlock" runat="server"></asp:Label>
                        <center><asp:Button ID="LabRegGetStatedBtn" CssClass="ButtonEditing" runat="server" Text="Get Started" OnClick="LabRegGetStatedBtn_Click" /></center>
                    </div>
                </div>
            </div>
        </div>
