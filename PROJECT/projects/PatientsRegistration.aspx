<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientsRegistration.aspx.cs" EnableEventValidation="false" Inherits="PatientsRegistration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid FindNoPadding">
            <div class=" BackGroundClr FindNoMargin"  style="background-image:url('../../images/mother-childcare-jaundice.jpg')">
                <p class="GetStartedText">Get Started With Online Best Medical Resolution System</p>
                <div class="row FindNoMargin">
                    <div class="col-sm-6 LeftDiv">
                        <center> <img src="images/hcue-patient-icon.png"/>
                        <p class="ImgHeading">Patient</p>
                    ...
                    <div class="col-sm-6 FormDiv">
                        <asp:TextBox ID="PatientRegNameTxt" CssClass="TextboxEditing" placeholder="Enter your full Name" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PatientRegEmailTxt" CssClass="TextboxEditing" placeholder="Enter your Email" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PatientRegPhoneTxt" CssClass="TextboxEditing" placeholder="Enter your Phone No" runat="server"></asp:TextBox>
                        <asp:RadioButtonList ID="PatientRegGenderRdo" runat="server" AutoPostBack="false" RepeatDirection="Horizontal" Width="306px">
                            <asp:ListItem>Male</asp:ListItem>
                            <asp:ListItem>Female</asp:ListItem>
                        </asp:RadioButtonList>
                        <asp:TextBox ID="PatientRegPwdTxt" CssClass="TextboxEditing" placeholder="Enter your Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:TextBox ID="PatientRegCnfPwdTxt" CssClass="TextboxEditing" placeholder="Confirm Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:Label ID="PatientRegMsgLbl" CssClass="LableBlock" runat="server"></asp:Label>
                        <center><asp:Button ID="PatientRegGetStartedBtn" CssClass="ButtonEditing" runat="server" Text="Get Started" OnClick="PatientRegGetStartedBtn_Click" /></center>
                    </div>
                </div>
            </div>
        </div>
