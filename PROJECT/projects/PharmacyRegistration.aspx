<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PharmacyRegistration.aspx.cs" EnableEventValidation="false" Inherits="PharmacyRegistration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid FindNoPadding" >
            <div class=" BackGroundClr FindNoMargin" style="background-image:url('../../images/pharmacy2.jpg')">
                <p class="GetStartedText">Get Started With Online Best Medical Resolution System</p>
                <div class="row FindNoMargin">
                    <div class="col-sm-6 LeftDiv">
                        <center> <img src="images/hcue-pharmacy-icon.png"/>
                        <p class="ImgHeading">Pharmacy</p>
                        <p class="DescriptionHeading">
                            Turn your Pharmacy into a Super-Pharmacy
                        </p>
                        <p>
                            All the intuitive features, thoughtfully designed to give you the edge to turn your
Pharmacy Store to a Super-Pharmacy.
                        </p>
                        </center>
                    </div>
                    <div class="col-sm-6 FormDiv">
                        <asp:TextBox ID="PharmacyRegNameTxt" CssClass="TextboxEditing" placeholder="Enter your full Name" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegEmailTxt" CssClass="TextboxEditing" placeholder="Enter your Email" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegPhoneTxt" CssClass="TextboxEditing" placeholder="Enter your Phone No" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegPharmacyNameTxt" CssClass="TextboxEditing" placeholder="Enter your Pharmacy Name" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegCityTxt" CssClass="TextboxEditing" placeholder="Enter your City" runat="server"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegPwdTxt" CssClass="TextboxEditing" placeholder="Enter your Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:TextBox ID="PharmacyRegCnfPwdTxt" CssClass="TextboxEditing" placeholder="Confirm Password" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:Label ID="PharmacyRegMsgLbl" CssClass="LableBlock" runat="server"></asp:Label>
                        <center><asp:Button ID="PharmacyRegGetStartedBtn" CssClass="ButtonEditing" runat="server" Text="Get Started" OnClick="PharmacyRegGetStartedBtn_Click" /></center>
