<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PharmacyAfterLogin.aspx.cs" Inherits="PharmacyAfterLogin" %>
            ...
            <div class="row FindNoMargin">
                ...
                <div class="col-sm-9 FindNoPadding">
                    ...
                    <div style="background-color: #28465A">
                        ...
                        <asp:Button ID="PrescriptionBtn" CssClass="MidButton" runat="server" Text="Prescriptions"></asp:Button>
                      
                        </center>
                    </div>

                    <div id="prescription" runat="server" style="border:1px solid #CCCCCC;padding-top:10px">
                      <div class="row" style="padding-left:10px">
                          <div class="col-sm-2" style="padding-bottom:4px">
                              Doctor:
                          </div>
                          <div class="col-sm-4" style="padding-bottom:4px">
                              <asp:Label ID="DocName" runat="server" Text="Label"></asp:Label>
                          </div>
                      </div>
                        <div class="row"  style="padding-left:10px" >
                          <div class="col-sm-2" style="padding-bottom:4px">
                         ...
                         <div class="row"  style="padding-left:10px" >
                          <div class="col-sm-4" style="padding-bottom:4px">
                              <asp:CheckBox ID="PaymentChkBox" runat="server" /> Payment Received
                          </div>
                          <div class="col-sm-2" style="padding-bottom:4px">
                              <asp:TextBox ID="AmountTxt" runat="server" placeholder="Enter Amount"></asp:TextBox>
                          </div>
