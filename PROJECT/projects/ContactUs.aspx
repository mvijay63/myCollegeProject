...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid FindNoPadding">
            <div class=" BackGroundClr FindNoMargin" style="background-image: url('../../images/DIAL.png')">
                <p class="GetStartedText"></p>
                <div class="row FindNoMargin">
                    ...
                    <div class="col-sm-6 FormDiv">
                        <asp:TextBox ID="ContactUsNameTxt" CssClass="TextboxEditing" placeholder="Enter your full Name" runat="server"></asp:TextBox>
                        <asp:TextBox ID="ContactUsEmailTxt" CssClass="TextboxEditing" placeholder="Enter your Email" runat="server" TextMode="Email"></asp:TextBox>
                        <asp:TextBox ID="ContactUsPhoneTxt" CssClass="TextboxEditing" placeholder="Enter your Phone No" runat="server" TextMode="Phone"></asp:TextBox>

                        <asp:TextBox ID="ContactUsMsgTxt" CssClass="TextboxEditing" placeholder="Your Message" runat="server" TextMode="Password"></asp:TextBox>
                        <asp:Label ID="DocRegMsgLbl" CssClass="LableBlock" runat="server"></asp:Label>
                        <center>
                        <asp:Button ID="DocRegGetStartedBtn" CssClass="ButtonEditing" runat="server" Text="Get Started" />
                        </center>
                    </div>
                </div>
            </div>
